      ...
      <div className="w-full lg:w-[45%] xl:w-[40%] flex flex-col justify-center px-8 sm:px-16 md:px-24 lg:px-16 xl:px-24 relative overflow-y-auto py-12">
        ...
        <div className="mb-10 text-center mt-16 lg:mt-0">
          ...
          <p className="text-gray-500 font-medium text-[15px]">
            Don't have an account? <Link to="/signup" className="text-[#d8684d] font-bold hover:underline">Sign up</Link>
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 w-full max-w-sm mx-auto">
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-bold text-gray-700 pl-1">Username</label>
        ...
        <p className="mt-12 text-center text-xs text-gray-400 font-medium w-full max-w-sm mx-auto">
          By clicking Sign in, you agree to accept Rimi's <Link to="#" className="font-bold text-gray-600 hover:text-gray-900">Terms of Service</Link>
        </p>
      </div>
